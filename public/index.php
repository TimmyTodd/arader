...
<div class="navbar-wrapper">
  <div class="container">
    <div class="navbar navbar-inverse navbar-static-top">
        ...
        <a id="logo" class="navbar-brand" href="#"><img src="img/logo-arader.png" width="128" height="127" alt="Arader Tree Service" /></a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <!-- <li class="active"><a href="index.php" title="TREE CARE">TREE CARE</a></li> -->
            <li><a href="index.php" title="TREE CARE">TREE CARE</a></li>
...
<div id="myCarousel" class="carousel slide">
  ...
  <div class="carousel-inner">
    ...
    <div class="item" style="background:url('http://placehold.it/1500X500') top center;">
      <div class="container">
        <div class="carousel-caption">
          <h1>Lorem ipsume header copyipsum.</h1>
          <p>Donec sit amet elit ac augue blandit volutpat quis eu dui. Sed imperdiet lacinia enim sit amet vestibulum. </p>
