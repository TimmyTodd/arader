  <div class="container-fluid gray-bg-footer">
    <div class="container">

      <!-- FOOTER -->
      <footer>
        <ul id="social" class="pull-right">
          <li><a href="https://www.facebook.com/pages/Arader-Tree-Service/436949546415195?fref=ts" title="Arader on Facebook" target="_blank"><i class="fa fa-facebook-square fa-3x"></i></a></li>
    ...
    <script src="js/arader.js"></script>
